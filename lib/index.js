...
NodeIce.prototype.toHtml = function (ops, callback) {
    ...
    IterateObject(tasks, function (cTask) {
    ...
    self.initTemplates(function (err, templates) {
        ...
        invoiceHtml = Mustache.render(templateContent, invoiceData);
...
NodeIce.prototype.convertToSecondary = function (input) {
    return input * this.options.data.currencyBalance.secondary / options.data.currencyBalance.main;
};
...
NodeIce.prototype.toPdf = function (ops, callback) {
    ...
    OneByOne([
      ...
      , function (next, html) {
  // TODO
        //    var render = Phantom(ops.phantom);
        //    if (typeof ops.output === "string") {
        //    }
